...
trait GlobalCrypto extends js.Object {
...
trait SubtleCrypto extends js.Object {
   ...
   * MDN
   */
  def encrypt(algorithm: Algorithm, key: CryptoKey,
      data: BufferSource): Promise[js.Any] = js.native
   ...
   * MDN
   */
  def decrypt(algorithm: Algorithm, key: CryptoKey,
      data: BufferSource): Promise[js.Any] = js.native
   ...
   * MDN
   */
  def sign(algorithm: Algorithm, key: CryptoKey,
      data: BufferSource): Promise[js.Any] = js.native
   ...
   * MDN
   */
  def verify(algorithm: Algorithm, key: CryptoKey, signature: BufferSource,
      data: BufferSource): Promise[js.Any] = js.native
   ...
   * MDN
   */
  def digest(algorithm: Algorithm,
      data: BufferSource): Promise[js.Any] = js.native
   ...
   * MDN
   */
  def generateKey(algorithm: Algorithm, extractable: Boolean,
   ...
   * MDN
   */
  def deriveKey(algorithm: Algorithm, baseKey: CryptoKey,
      derivedKeyType: String, extractable: Boolean,
      keyUsages: js.Array[String]): Promise[js.Any] = js.native
   ...
   * MDN
   */
  def deriveBits(algorithm: Algorithm, baseKey: CryptoKey,
      length: Double): Promise[js.Any] = js.native
   ...
   */
  def importKey(format: String, keyData: BufferSource,
      algorithm: Algorithm, extractable: Boolean,
      keyUsages: js.Array[String]): Promise[js.Any] = js.native
   ...
   */
  def wrapKey(format: String, key: CryptoKey, wrappingKey: CryptoKey,
      wrapAlgorithm: Algorithm): Promise[js.Any] = js.native
   ...
   */
  def unwrapKey(format: String, wrappedKey: BufferSource,
      unwrappingKey: CryptoKey, unwrapAlgorithm: Algorithm,
      unwrappedKeyAlgorithm: String, extractable: Boolean,
      keyUsages: js.Array[String]): Promise[js.Any] = js.native
  ...
  def unwrapKey(format: String, wrappedKey: BufferSource,
      unwrappingKey: CryptoKey, unwrapAlgorithm: String,
      unwrappedKeyAlgorithm: Algorithm, extractable: Boolean,
      keyUsages: js.Array[String]): Promise[js.Any] = js.native
...
object RsaKeyGenParams {
  ...
  def apply(name: String, modulusLength: Long,
    ...
    js.Dynamic.literal(name = name, modulusLength = modulusLength,
